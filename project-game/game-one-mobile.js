...
function collisionCheck() {
  if (gameOver) {
    ...
    baddiesCount.forEach((enem, index) => {
      ...
      if (
        (baddiePos.top > barfPos.top && baddiePos.top < barfPos.bottom - 10) ||
        (baddiePos.bottom + 10 > barfPos.top &&
          baddiePos.bottom < barfPos.bottom)
      ) {
        verticalMatch = true
      } else {
        verticalMatch = false
      ...
      if (
        (baddiePos.right > barfPos.left + 10 &&
          baddiePos.right < barfPos.right) ||
        (baddiePos.left < barfPos.right - 10 && baddiePos.left > barfPos.left)
      ) {
